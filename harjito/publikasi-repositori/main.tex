%% Dokumen contoh: publikasi-repositori — publikasi ilmiah versi repositori: tanpa isi artikel (panduan hal. 59)
...
\documentclass[jenis=publikasi,mode=repositori,jenjang=sarjana,sitasi=apa,logodir=../../logo,logo=logo-unnes]{unnes-ta}
...
\input{bab/01-tautan-dan-keterangan-publikasi}
