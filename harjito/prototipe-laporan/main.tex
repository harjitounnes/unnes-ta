%% Dokumen contoh: prototipe-laporan — prototipe laporan, jenjang diploma
...
%% Rujukan sistematika menurut panduan: hal. 43-45 (proposal), hal. 45-46 (laporan)
...
\documentclass[jenis=prototipe,mode=laporan,jenjang=diploma,sitasi=ieee,logodir=../../logo,logo=logo-unnes]{unnes-ta}
...
\input{../identitas}
\identitas{
  judul  = {Rancang Bangun Alat Monitoring Kualitas Air Kolam Budi Daya Berbasis Internet of Things},
  gelar  = {Ahli Madya},
}
...
\input{lampiran/01-draf-karya-sketsa}

\input{lampiran/02-luaran-hki}

\input{lampiran/03-publikasi-media}

\input{lampiran/04-dokumentasi}

\input{lampiran/05-sk-pembimbing}
