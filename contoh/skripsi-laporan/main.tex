%% Dokumen contoh: skripsi-laporan — skripsi laporan, jenjang sarjana, dua pembimbing
...
\documentclass[jenis=skripsi,mode=laporan,jenjang=sarjana,sitasi=apa,logodir=../../logo,logo=logo-unnes]{unnes-ta}
