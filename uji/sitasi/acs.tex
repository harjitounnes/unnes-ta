%% Uji gaya sitasi: acs — ACS (hal. 92 butir 3f)
%% Kompilasi: TEXINPUTS=../../:../../bst: BSTINPUTS=../../bst:
%%            pdflatex acs && bibtex acs && pdflatex acs (2x)
...
\documentclass[sitasi=acs,logodir=../../logo,logo=logo-placeholder]{unnes-ta}

\identitas{
  judul    = {Uji Gaya Sitasi acs},
  nama     = {Nama Mahasiswa},
  nim      = {1234567890},
