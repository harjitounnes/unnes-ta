%% Uji gaya sitasi: mla — MLA (hal. 92 butir 3c)
%% Kompilasi: TEXINPUTS=../../:../../bst: BSTINPUTS=../../bst:
%%            pdflatex mla && bibtex mla && pdflatex mla (2x)
...
\documentclass[sitasi=mla,logodir=../../logo,logo=logo-placeholder]{unnes-ta}

\identitas{
  judul    = {Uji Gaya Sitasi mla},
  nama     = {Nama Mahasiswa},
  nim      = {1234567890},
