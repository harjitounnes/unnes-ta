%% Uji gaya sitasi: ieee — IEEE (hal. 92 butir 3b)
%% Kompilasi: TEXINPUTS=../../:../../bst: BSTINPUTS=../../bst:
%%            pdflatex ieee && bibtex ieee && pdflatex ieee (2x)
...
Penelitian campuran dibahas pada \cite{creswell2018research} secara mendalam.
...
Perintah \texttt{citemla} sengaja tidak dipakai di gaya bernomor karena berkas gaya IEEE/ACS tidak memuat daftar nama penulis; kelas akan menolaknya.
