%% Uji gaya sitasi: harvard — Harvard (hal. 92 butir 3e)
%% Kompilasi: TEXINPUTS=../../:../../bst: BSTINPUTS=../../bst:
%%            pdflatex harvard && bibtex harvard && pdflatex harvard (2x)
...
\documentclass[sitasi=harvard,logodir=../../logo,logo=logo-placeholder]{unnes-ta}

\identitas{
  judul    = {Uji Gaya Sitasi harvard},
  nama     = {Nama Mahasiswa},
  nim      = {1234567890},
